...
class Ingredient(ImageCacheMixin, models.Model):
    ...
    def thumbnail_mini(self):
        return self.get_cached_image_url("photo", "mini")

    @property
    def thumbnail_small(self):
        return self.get_cached_image_url("photo", "small")

    @property
    def thumbnail_large(self):
        return self.get_cached_image_url("photo", "large")
    ...
    def save(self, *args, **kwargs):
        ...
        if self.pk:
            try:
                old_instance = Ingredient.objects.get(pk=self.pk)
